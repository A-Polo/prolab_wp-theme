        ...
        <?php endif; ?>
         ...
         <div class="product-buy">
             ...
             echo apply_filters( 'woocommerce_loop_add_to_cart_link',
             	sprintf( "<a rel='nofollow' href='%s' data-quantity='%s' data-product_id='%s' data-product_sku='%s' class='%s' onClick='ga('send', 'event', { eventCategory: 'preview order3', eventAction: 'order3'});'>%s</a>",
